...
public abstract class AccountDto {
      ...
      */
     @NotNull(message = "principalAmount is missing")
     Double principalAmount;

     /**
      * interestRate of the Customer
      */
     @NotNull(message = "interestRate is missing")
     Double interestRate;
     ...
     @JsonIgnore
     public Long getMonthsCountFromOpening() {
     ...
     final Double calcIntrestByMonth() {
          months = getMonthsCountFromOpening();
