...
class CustomerServiceApplicationTests {
	...
	void testFixedDepositAccountIsMaturingDepositYes() {
		LocalDate dateOfOpening = LocalDate.of(2023, Month.AUGUST, 15);
		FixedDepositAccountDto fixedDepositAccount = FixedDepositAccountDto.builder().accountNumber("123445L").
													...
													build();
		assertEquals(fixedDepositAccount.isMaturingDepositWithInMonth(3), false);
	}
	...
	void testMaturityAmountValid() {
		...
		LocalDate maturityDt = LocalDate.of(2024, Month.AUGUST, 15);
		FixedDepositAccountDto fixedDepositAccount = FixedDepositAccountDto.builder().accountNumber("123445L").
													principalAmount(1000.0).
													interestRate(10.0).
													dateOfOpening(dateOfOpening.toString()).
													maturityDate(maturityDt.toString()).
													build();
